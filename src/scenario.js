...
var SCENARIO = {
  ...
  buffer: 2500,
  accounts: [
    { name: 'Current account', balance: 4812.40 },
    { name: 'Joint account', balance: 1930.15 },
    { name: 'Savings', balance: 18400.00, inForecast: false }
  ],
  recurring: [
    { id: 'sal-1', label: 'Net salary — Hilde', amount: 3184.00, cadence: 'monthly', on: '2026-09-27', category: 'salary' },
    { id: 'sal-2', label: 'Freelance invoices — Bram', amount: 1450.00, cadence: 'monthly', on: '2026-09-15', category: 'salary', estimate: true },
    ...
    { id: 'gro', label: 'Groceries', amount: -168.00, cadence: 'weekly', on: '2026-09-12', category: 'living', estimate: true },
